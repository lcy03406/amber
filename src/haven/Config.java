...
public class Config {
    ...
    public static boolean daylight = Utils.getprefb("daylight", true);
    ...
    public static boolean studylock = Utils.getprefb("studylock", true);
    public static boolean chatsave = Utils.getprefb("chatsave", true);
    public static boolean bartersave = Utils.getprefb("bartersave", true);
    ...
    public static boolean alarmred = Utils.getprefb("alarmred", true);
    ...
    public static boolean mapshowgrid = Utils.getprefb("mapshowgrid", true);
    public static boolean mapshowviewdist = Utils.getprefb("mapshowviewdist", true);
    public static boolean disabletiletrans = Utils.getprefb("disabletiletrans", true);
    public static boolean itemmeterbar = Utils.getprefb("itemmeterbar", true);
    public static boolean showprogressperc = Utils.getprefb("showprogressperc", true);
    public static boolean timersalarm = Utils.getprefb("timersalarm", true);
    ...
    public static boolean statuswdgvisible = Utils.getprefb("statuswdgvisible", true);
    ...
    public static boolean showplantgrowstage = Utils.getprefb("showplantgrowstage", true);
    public static boolean notifykinonline = Utils.getprefb("notifykinonline", true);
    public static boolean showminerad = Utils.getprefb("showminerad", true);
    public static boolean showfarmrad = Utils.getprefb("showfarmrad", true);
    ...
    public static boolean unhidenearcrops = Utils.getprefb("unhidenearcrops", true);
    public static boolean showfps = Utils.getprefb("showfps", true);
    public static boolean autohearth = Utils.getprefb("autohearth", false);
    public static boolean showplayerpaths = Utils.getprefb("showplayerpaths", true);
    ...
    public static boolean tilecenter = Utils.getprefb("tilecenter", true);
    ...
    public static boolean enabletracking = Utils.getprefb("enabletracking", true);
    ...
    public static boolean hwcursor = Utils.getprefb("hwcursor", true);
    public static boolean showboundingboxes = Utils.getprefb("showboundingboxes", true);
    public static double alarmonforagablesvol = Utils.getprefd("alarmonforagablesvol", 0.8);
    public static boolean alarmlocres = Utils.getprefb("alarmlocres", true);
    public static double alarmlocresvol = Utils.getprefd("alarmlocresvol", 0.8);
    public static boolean alarmtroll = Utils.getprefb("alarmtroll", true);
    ...
    public static boolean nodropping = Utils.getprefb("nodropping", true);
    public static boolean nodropping_all = Utils.getprefb("nodropping_all", true);
    public static boolean fbelt = Utils.getprefb("fbelt", true);
    public static boolean histbelt = Utils.getprefb("histbelt", true);
    public static boolean dropMinedStones = Utils.getprefb("dropMinedStones", true);
    public static boolean dropMinedOre = Utils.getprefb("dropMinedOre", false);
    public static boolean dropMinedOrePrecious = Utils.getprefb("dropMinedOrePrecious", false);
    public static boolean dropMinedCurios = Utils.getprefb("dropMinedCurios", false);
    ...
    public static boolean enableorthofullzoom = Utils.getprefb("enableorthofullzoom", true);
    public static boolean partycircles =  Utils.getprefb("partycircles", true);
    public static boolean alarmbram =  Utils.getprefb("alarmbram", true);
    ...
    public static boolean logcombatactions =  Utils.getprefb("logcombatactions", true);
    public static boolean autopickmussels =  Utils.getprefb("autopickmussels", true);
    ...
    public static boolean studyhist =  Utils.getprefb("studyhist", true);
    public static boolean studybuff =  Utils.getprefb("studybuff", true);
    public static int zkey =  Utils.getprefi("zkey", KeyEvent.VK_Z);
    public static boolean disableterrainsmooth =  Utils.getprefb("disableterrainsmooth", true);
    ...
    public static boolean highlightpots = Utils.getprefb("highlightpots", true);
    public static boolean bonsai = Utils.getprefb("bonsai", true);
    public static int fontsizechat = Utils.getprefi("fontsizechat", 14);
    public static boolean fontaa = Utils.getprefb("fontaa", true);
    public static boolean usefont = Utils.getprefb("usefont", true);
    public static String font = Utils.getpref("font", "SansSerif");
    public static int fontadd = Utils.getprefi("fontadd", 0);
    public static boolean proximityaggro = Utils.getprefb("proximityaggro", true);
    public static boolean minimapsmooth = Utils.getprefb("minimapsmooth", true);
    public static boolean proximityaggroanimal = Utils.getprefb("proximityaggroanimal", true);
    public static boolean proximitychase = Utils.getprefb("proximitychase", true);
    public static boolean proximitylift = Utils.getprefb("proximitylift", true);
    public static boolean autogive = Utils.getprefb("autogive", true);
    public static boolean enablel10ndebug = Utils.getprefb("enablel10ndebug", false);//DK
    public static boolean straightcavewall = Utils.getprefb("straightcavewall", true);
    public static boolean placecam = Utils.getprefb("placecam", true);
    public static boolean msglog = Utils.getprefb("msglog", true);
    public static boolean foodbaseq = Utils.getprefb("foodbaseq", true);
